            ...
            <div className="about">
                <section id="AboutMe">
                    ...
                    <div className="profile1">
                        ...
                        <p className="about__p">I am Pouyan Zarbafian, an alumni of Concordia University in Computer Science, and LightHouse Labs alumni in Web development. I also graduated from BrainStation College as a Full Stack Web Developer in 2018.<br/> According to my education, I learned and deepened my understanding of the latest web development tools and skills.</p>
